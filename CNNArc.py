...
if not data_augmentation:
    ...
    # Data augmentaion to reduce overfitting on image data by artificially enlarge
    # the dataset using label-preserving transformations

    # To do preprocessing and realtime data augmentation
